...
void redGreenTask()
{
	...
	SCH_Add_Task(redYellowTask, greenCounter * 1000, 0);
...
void redYellowTask()
{
	...
	SCH_Add_Task(greenRedTask, yellowCounter * 1000, 0);
...
void greenRedTask()
{
	...
	SCH_Add_Task(yellowRedTask, greenCounter * 1000, 0);
...
void yellowRedTask()
{
	...
	SCH_Add_Task(redGreenTask, yellowCounter * 1000, 0);
...
void fsm_automatic_run()
{
	...
	if (isButton1Pressed()) {
		...
		SCH_Delete_Task(nextTask_Switch_State);
	}
